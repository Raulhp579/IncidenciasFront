...
export class FormularioIncidencia {
  constructor(private incidenciaService: IncidenciaService,private usuarioService:UsuarioService) {}
  ...
  onSubmit() {
    ...
    this.usuarioService.getPorNombre(clienteNombre)
      .subscribe((cliente: Usuario) => {
        const incidencia = {
          ...
          cliente: cliente,
          tecnico: this.loginForm.value.tecnico || null, //falta buscar por nombre tecnico
        };
